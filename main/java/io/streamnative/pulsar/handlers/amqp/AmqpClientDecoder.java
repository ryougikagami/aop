...
public class AmqpClientDecoder extends AMQDecoder<ClientMethodProcessor<? extends ClientChannelMethodProcessor>>
{
    ...
    {
        // log.info("incomingBuffer.remaining()------------"+incomingBuffer.remaining());
...
//                _incompleteBuffer = QpidByteBuffer.allocateDirect(qpidByteBuffer.remaining() + required);
...
//                final QpidByteBuffer aggregatedBuffer =
//                        QpidByteBuffer.allocateDirect(_incompleteBuffer.remaining() + incomingBuffer.remaining());
...
//                    _incompleteBuffer = QpidByteBuffer.allocateDirect(aggregatedBuffer.remaining() + required);
            ...
            throws AMQFrameDecodingException
    {
        ...
        try
        {
            ...
            // log.info("amqpClientDecoder processMethod");
            // log.info("classAndMethod--------" + Integer.toHexString(classAndMethod));
