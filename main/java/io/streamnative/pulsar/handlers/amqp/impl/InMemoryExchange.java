...
public class InMemoryExchange extends AbstractAmqpExchange {
    ...
    public InMemoryExchange(String exchangeName, Type exchangeType, boolean autoDelete) {
        super(exchangeName, exchangeType, new CopyOnWriteArraySet<>(), new ConcurrentHashMap<>(), false, autoDelete);
