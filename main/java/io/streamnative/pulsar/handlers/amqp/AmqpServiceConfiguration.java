...
public class AmqpServiceConfiguration extends ServiceConfiguration {
    ...
    private String amqpListeners = "amqp://127.0.0.1:5672,amqp+ssl://127.0.0.1:5671";
    ...
    private String amqpServerKeystore;
    @FieldContext(
            category = CATEGORY_AMQP_PROXY,
            required = false,
            doc = "Whether start amqp protocol handler with proxy"
    )
    private String amqpServerKey;
    //    @FieldContext(
//            category = CATEGORY_AMQP_PROXY,
//            required = false,
//            doc = "Whether start amqp protocol handler with proxy"
//    )
    private String amqpSslOptionsCacertfile;
    //    @FieldContext(
//            category = CATEGORY_AMQP_PROXY,
//            required = false,
//            doc = "Whether start amqp protocol handler with proxy"
//    )
    private String amqpSslOptionsCertfile;
    //    @FieldContext(
//            category = CATEGORY_AMQP_PROXY,
//            required = false,
//            doc = "Whether start amqp protocol handler with proxy"
//    )
    private String amqpSslOptionsKeyfile;
    //    @FieldContext(
//            category = CATEGORY_AMQP_PROXY,
//            required = false,
//            doc = "Whether start amqp protocol handler with proxy"
//    )
    private String amqpSslOptionsPassword;
    //    @FieldContext(
//            category = CATEGORY_AMQP_PROXY,
//            required = false,
//            doc = "Whether start amqp protocol handler with proxy"
//    )
    private String amqpSslOptionsVersions ;
    ...
    private String amqpSslKeyPassword ;
}
